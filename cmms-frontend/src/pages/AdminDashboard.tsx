...
const sidebarItems: SidebarItem[] = [
  { name: 'Overview', icon: ChartBarIcon, path: '/admin/dashboard' },
  { name: 'User Management', icon: UsersIcon, path: '/admin/users' },
  { name: 'Equipment Management', icon: CubeIcon, path: '/admin/equipment' },
  { name: 'Repair Requests', icon: DocumentTextIcon, path: '/admin/repair-requests' },
  { name: 'Maintenance Reports', icon: ClipboardIcon, path: '/admin/maintenance-reports' },
];
      ...
      >
        ...
        <div className="absolute bottom-0 w-full p-6 border-t">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <p className="font-medium text-gray-800">{user?.name || user?.username || user?.email || "Administrator"}</p>
